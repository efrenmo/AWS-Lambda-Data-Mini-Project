...
LOG_FILE1=$(date +"%m%d%Y%H%M%S")
LOG_FILE2=$(date +"%Y-%m-%d_%Z_%H%M%S")
#########################################################
# Part 2: SET VARIABLES 

# get the name of the py_script from config.toml, and remove the quotes
...
export LOG_FILE=${LOGDIR}/run.sh_${LOG_FILE2}.log
#########################################################
